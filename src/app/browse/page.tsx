...
import { DONATIONS, CATEGORY_META } from '@/lib/data';
...
export default function BrowsePage() {
  ...
  const filtered = useMemo(() => DONATIONS.filter((d) => {
    ...
    const matchSearch = !q || d.title.toLowerCase().includes(q) || d.city.toLowerCase().includes(q) || d.itemType.toLowerCase().includes(q);
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="section-wrapper py-10">
          ...
          <p className="text-gray-500 mt-2">Find available food, clothes, and books near you</p>
        </div>
      </div>
      ...
      <div className="section-wrapper py-8">
        ...
        {filtered.length === 0 ? (
          <div className="text-center py-24">
            ...
            <p className="text-xl font-semibold text-gray-700">No donations found</p>
