...
export default function DonationCard({ donation: d }: { donation: DonationRow }) {
  ...
  async function handleOpenWhatsApp() {
    ...
    try {
      ...
      setSubmitted(true);
      // Open WhatsApp with pre-filled message to donor
          ...
          {submitted && (
            <div className="bg-green-50 border border-green-200 rounded-xl p-4 text-center">
              ...
              <p className="text-xs text-green-700 mt-1">
                Send the message to the donor. Once you collect the item, the donor will mark it as collected.
              </p>
            </div>
          )}
            ...
            <div className="flex flex-col gap-3">
              <div className="bg-green-50 border border-green-200 rounded-xl p-4 flex flex-col gap-3">
                ...
                <label className="flex items-start gap-2 cursor-pointer bg-amber-50 border border-amber-200 rounded-xl p-3">
                  ...
                  <span className="text-xs text-amber-800 leading-relaxed">
                    I understand that <strong>DontWaste is a free, non-commercial platform</strong> and is not responsible
                ...
                <button
                  ...
                  {submitting ? 'Opening WhatsApp...' : 'Open WhatsApp to Contact Donor'}
                </button>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-xs text-gray-500 leading-relaxed">
                ...
                <ul className="space-y-1">
                  ...
                  <li>• Report misuse to support@dontwaste.in. This platform is for <strong>genuine good use only</strong>.</li>
                </ul>
              </div>
            </div>
          )}
