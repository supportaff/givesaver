...
function buildWhatsAppURL(donation: Donation): string {
  ...
  // Make sure it has country code — default +91 if 10 digits
  ...
  const msg = [
    ...
    ``,
    `I saw your donation listing on *GiveSaver* and I'm interested in collecting it.`,
    ``,
    `📋 *Listing Details*`,
    `• Item: ${donation.title}`,
    ...
    ``,
    `I represent a genuine need (personal / NGO / community welfare) and I pledge not to resell these items commercially.`,
    ``,
    `Could we arrange a pickup at your convenience? Thank you for your kindness! 🙏`,
    ``,
    `— via GiveSaver (givesaver.in)`,
  ].join('\n');
